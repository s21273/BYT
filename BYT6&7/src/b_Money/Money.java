...
public class Money implements Comparable {
	...
	public String toString() {
		return (double)this.getAmount()/100+ " "+this.currency.getName();
	}
	...
	public Money add(Money other) {
		Integer convertedOtherMoney = this.getCurrency().valueInThisCurrency(other.getAmount(), other.getCurrency());
		
		return new Money(this.getAmount()+ convertedOtherMoney, this.getCurrency());
	...
	public int compareTo(Object o) {
		...
		Money other = (Money)o;
		Integer thisMoney = this.universalValue();
		Integer otherMoney = other.universalValue();
		if(thisMoney.compareTo(otherMoney)==0) {
			return 0;
		} else if(thisMoney.compareTo(otherMoney)<0) {
			return -1;
		} else  
			return 1;
