...
public class Bank {
	 ...
	 */
	public void openAccount(String accountid, String name) throws AccountExistsException {
		if (accountlist.containsKey(accountid)) {
			throw new AccountExistsException();
		}
		else {
			Account acc = new Account(name, this.getCurrency());
	...
	public void transfer(String fromaccount, String toaccount, Money amount) throws AccountDoesNotExistException {
		if (!accountlist.containsKey(fromaccount) || !accountlist.containsKey(toaccount)) {
			throw new AccountDoesNotExistException();
		} else 	accountlist.get(fromaccount).withdraw(amount);
